...
const englishMessages = {
  ...
  "services.testDescription": "Choose a capability to test with the configured provider:",
  ...
  "services.searchTestDescription": "Enter a query to run a real search with this configured provider credential.",
  ...
  "services.searchNoResults": "The provider returned no displayable search results.",
  "services.searchConsumesQuota": "This test sends the query to the provider and may consume search quota.",
  "services.extractTest": "Test extraction",
  "services.extractTestTitle": "Content extraction test",
  "services.extractTestDescription": "Enter one HTTPS URL per line to run a real Tavily Extract request with the configured credential.",
  "services.extractURLs": "HTTPS URLs",
  "services.extractURLsPlaceholder": "https://example.com/page\nhttps://example.com/another-page",
  ...
  "services.extractConsumesQuota": "This test sends URLs to the provider and consumes Extract credits for successful URLs.",
  ...
  "providers.allowanceMetrics.tavilyAccountPaygo": "Account pay-as-you-go credits",
...
const chineseMessages: Messages = {
  ...
  "services.searchTestDescription": "输入查询文本，使用该供应商已经配置的凭据执行一次真实搜索。",
  ...
  "services.searchConsumesQuota": "该测试会把查询发送给供应商，并可能消耗搜索额度。",
  "services.extractTest": "测试提取",
  "services.extractTestTitle": "内容提取测试",
  "services.extractTestDescription": "每行输入一个 HTTPS URL，使用已配置凭据执行一次真实 Tavily Extract 请求。",
  ...
  "services.extractConsumesQuota": "该测试会把 URL 发送给供应商，并按成功提取的 URL 消耗 Extract Credit。",
