...
const englishMessages = {
  ...
  "diagnostics.accessDescription": "Redacted route audit and aggregate traffic metrics. Tokens, bodies, prompts, and provider content are excluded.",
  ...
  "providers.getSupportedModels": "Get supported models",
  ...
  "providerConfig.additionalParametersInvalid": "Additional parameter rules are invalid.",
  "providerConfig.additionalParametersSaveFailed": "Unable to save provider additional parameters.",
  "providerConfig.saveAdditionalParameters": "Save additional parameters",
  "providerConfig.modelAdditionalParameters": "Model additional parameter overrides",
  ...
  "providerConfig.projectionEffortRequired": "Supported reasoning requires at least one effort rule.",
  "providerConfig.projectionReasoningUnsupported": "A model without reasoning support cannot define effort or summary rules; additional parameters remain available.",
  ...
  "providerConfig.endpointRequired": "This provider does not have an editable API endpoint.",
...
const chineseMessages: Messages = {
  ...
  "diagnostics.accessDescription": "显示脱敏路由审计与聚合流量指标，不包含令牌、请求正文、提示词或供应商内容。",
  ...
  "providers.models": "模型",
  "providers.getSupportedModels": "获取支持的模型",
  ...
  "providerConfig.addSystemDescription": "选择精确的供应商接口，然后通过其原生授权流程新增凭据。",
  "providerConfig.credentialTarget": "目标供应商配置",
  "providerConfig.credentialTargetHelp": "新凭据会加入该既有供应商配置，不会克隆供应商。",
  "providerConfig.firstCredentialCreatesConfiguration": "该接口尚未配置；首次授权成功时会同时创建供应商配置与首个凭据。",
  "providerConfig.configurationDescription": "查看入口与模型，并进入对应的供应商配置功能。",
  ...
  "providerConfig.projectionEffortRequired": "启用推理时至少需要一条推理强度规则。",
  "providerConfig.projectionReasoningUnsupported": "模型不支持推理时不能定义强度或摘要规则；仍可配置额外参数。",
