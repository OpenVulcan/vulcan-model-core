...
const englishMessages = {
  ...
  "providers.deleteCredentialDescription":
    "This permanently removes the credential and its access bindings. Deleting the final credential also removes the provider instance.",
...
const chineseMessages: Messages = {
  ...
  "providers.deleteCredentialDescription":
    "这会永久删除该凭据及其访问绑定。删除最后一个凭据时也会删除对应的供应商实例。",
