...
~~~text
POST   /vulcan/v1/responses
GET    /vulcan/v1/responses/{response_id}
POST   /vulcan/v1/responses/{response_id}/cancel
POST   /vulcan/v1/responses/compact
GET    /vulcan/v1/catalog
POST   /vulcan/v1/resolve
~~~

图片、音频、文件、视频和异步媒体能力使用各自的专用协议面；它们不得重新定义一套通用对话或工具消息协议。
