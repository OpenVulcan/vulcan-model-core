...
func newChatDriverExecution(t *testing.T, baseURL string, stream bool) (*ChatDriver, provider.ExecutionRequest) {
	...
	execution := provider.ExecutionRequest{
		...
		Definition: providerconfig.ProviderDefinition{ID: "definition-1", Kind: providerconfig.DefinitionKindSystem, AuthMethods: []providerconfig.AuthMethodDefinition{{ID: "api-key", Type: providerconfig.AuthMethodAPIKey}}, Channels: []providerconfig.ProviderChannel{{ID: "channel-1", ProtocolProfileID: chatTestProfileID, AuthMethodIDs: []string{"api-key"}, RuntimeReady: true}}},
